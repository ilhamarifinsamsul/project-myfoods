<div>
    <header style="background-image: url('{{ asset("assets/images/bg-hero.svg") }}');"
    class="rounded-b-3xl bg-cover font-poppins">
        <div class="p-6">
            <div class="rounded-3xl bg-white px-5 py-2">
                ...
                <div style="background-image: url('{{ asset("assets/images/bg-swiggly-line.svg") }}');">
            ...
            <div class="mt-5">
                ...
                <form action="" method="GET" class="flex overflow-hidden rounded-full">
                    <input type="search" class="h-12 w-full appearance-none rounded-full px-4 placeholder:font-semibold placeholder:text-black-30" placeholder="Cari Makanan" wire:model.live.debounce.500ms='"term' />
                    @if (! $term)
                        <img
            ...
            @if ($term == "")
                <div>
                    <div class="container flex items-center justify-between">
                        ...
                        <a href="/food/promo" wire:navigate
                ...
                <div class="container">
                    <div style="
                        ...
                        <h3 class="text-left text-2xl font-semibold text-black-100">Cita Rasa Lokal <br> Harga Super Lokal!!
                        </h3>
                        <a href="/food" wire:navigate class="block w-fit rounded-full bg-primary-50 px-6 py-2 font-semibold text-white">Lihat Semua Menu
                        </a>
                    </div>
                </div>
